...
[paper]: https://ieeexplore.ieee.org/document/11223631
...
CISSIR extends **5G-NR beamforming** with a principled **low self-interference (SI)** design
to enable
[integrated sensing and communication (ISAC)](https://isac.committees.comsoc.org/).
CISSIR's main features include:

- :hammer_and_wrench: High versatility: Suitable for hybrid or analog, phased or tapered antenna arrays, even under multipath SI.
- :memo: Theoretical performance guarantees for sensing SNR in the face of analog/mixed-signal distortion.
- :zap: Better performance[^1] and faster[^2] than cutting-edge beam codebooks for full-duplex communication.
